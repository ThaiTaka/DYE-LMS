  ...
  return (
    <>
      <header className="mb-7">
        <h1 className="mt-0 mb-2 text-3xl font-extrabold sm:text-4xl">
          <ChuNeon>Dự án game của em</ChuNeon> 🎮
        </h1>
            ...
            {duAn.map((d) => {
              ...
              return (
                <li key={d.id}>
                  <Link
                    href={`/du-an/${d.id}`}
                    className="kinh block h-full rounded-the p-5 transition-colors hover:border-chinh-sang/60"
                  >
      ...
      <TheKinh as="section" aria-labelledby="tao-moi" className="p-5 sm:p-6">
